...
<div class="tasks-form">
    <?php if ($user_id): ?>
        ...
        <?= $form->field($model, 'create_user_id')->hiddenInput(['value' => $user_id])->label(false) ?>
        ...
        <?php ActiveForm::end(); ?>
    <?php else: ?> 
        <h3>Для создании задачи необходимо авторизоваться</h3>
    <?php endif; ?>
</div>
<script>
    console.dir(document.getElementsByClassName('field-exec_date')[0]);
</script>
