...
class HelpTelegram {
    ...
    public function __construct() {
        ...
        $this->response .= "/task_create ##task_name## ##2019-01-10(deadline)## ##description## ##responsible_id## ##project_id## - создание новой задачи. Имя задачи и дата выполнения - обязательные параметры!\n";
